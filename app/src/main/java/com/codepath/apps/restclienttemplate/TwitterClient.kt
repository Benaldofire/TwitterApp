...
class TwitterClient(context: Context) : OAuthBaseClient(
    ...
    companion object {
        ...
        const val REST_URL = "https://api.twitter.com/1.1" // Update this twitter 2.0 afterwards
    ...
    fun getNextTimeline(handler: JsonHttpResponseHandler, maxID: Long) {
        val apiUrl =
            getApiUrl("statuses/home_timeline.json")

        // Can specify query string params directly or through RequestParams.
        Log.i("Ben","Next page request made, MAX_ID: $maxID")
        val params = RequestParams()
        params.put("count", "25")
